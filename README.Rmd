...
dat.f2<-sim.pop.f2(n.ind = n.ind, n.mrk = n.mrk, ch.len = ch.len, dom43 = 30, dom51 = 1, missing = mis, n.ch = n.ch, verbose = FALSE)


sourceCpp("cpp/hmm_f2_old.cpp")
sourceCpp("cpp/hmm_f2.cpp")
sourceCpp("cpp/hmm_f2_new.cpp")
sourceCpp("cpp/hmm_f2_brand_new.cpp")

system.time(z0<-est_hmm_f2_old(Geno = t(dat.f2$geno), rf = rep(0.05, (n.mrk-1)),1))
system.time(z1<-est_hmm_f2(Geno = t(dat.f2$geno), rf = rep(0.05, (n.mrk-1)),1))
system.time(z2<-est_hmm_f2_new(Geno = t(dat.f2$geno), rf = rep(0.05, (n.mrk-1)),1))
system.time(z3<-est_hmm_f2_brand_new(Geno = t(dat.f2$geno), rf = rep(0.05, (n.mrk-1)),1))
```
